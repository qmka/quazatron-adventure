const verbs = [{
    ...
    id: 16,
    forms: ["положи", "выбрось", "оставь", "выброси", "положить", "выбросить", "оставить", "брось", "кидай", "метни", "бросить", "кинуть", "метнуть"],
    method: "dropItem"
}, {
    id: 17,
    forms: ["о", "осм", "ос", "ис", "изуч", "осмотри", "изучи", "исследуй", "осмотреть", "изучить", "исследовать"],
    method: "examine"
}, {
    id: 18,
    forms: ["жди", "ж"],
