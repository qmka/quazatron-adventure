const locations = [
    ...
    id: 9,
    desc: "Вы на верхушке дерева. Путь отсюда только вниз, на землю.",
    dir: {
        d: 8
    },
    img: 'location009.png'
    ...
    id: 11,
    desc: 'Вы снаружи зловеще выглядящего замка, некогда величественного, а сейчас по большей части превратившегося в руины. Дорога идёт на восток и упирается в большую чёрную !*дверь*!.',
    dir: {
        e: 15,
        w: 10,
    },
    ...
    id: 24,
    desc: "Вы в соляной шахте. Когда-то здесь работали люди, но заметно, что это место давно заброшено. Слышно, как где-то капает вода. Выход отсюда - на север.",
    dir: {
        n: 23,
    },
    img: 'location024.png'
    ...
    id: 26,
    desc: "Вы в маленькой ярко освещённой комнате. Из мебели здесь только пустой шкаф, а также чудом сохранившийся резной алтарь. Из дыры в стене струится солнечный свет, но на алтаре стоят свечи. Выход отсюда - на западе.",
    dir: {
        w: 25,
    },
    img: 'location026.png'
