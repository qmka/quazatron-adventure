...
// Если вы хотите, чтобы какой-либо предмет был в инвентаре игрока на старте игры, раскомментируйте строку выше и назначьте USER_HAVE_ITEM нужному предмету в state.place
...
const locations = [{
    index: 0,
    desc: 'Вы находитесь в охотничьем домике. Здесь тепло, уютно, и вовсю рещит углями разведённый вами камин. Выход из домика - через дверь на севере.',
