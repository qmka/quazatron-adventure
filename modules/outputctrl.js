...
const outputCtrl = (g, input) => {
    ...
    switch (input.verb) {
        case "помоги":
            answer = 'Я понимаю команды в формате ГЛАГОЛ + ОБЪЕКТ (+ ОБЪЕКТ), например, <span style="color: white;">ВОЗЬМИ ЛЕСТНИЦУ</span> или <span style="color: white;">НАБЕРИ ВОДЫ В КУВШИН.</span><br>Используйте команды <span style="color: white;">С Ю З В ВВЕРХ ВНИЗ</span> для передвижения.<br>Команда <span style="color: white;">ОСМОТРИ</span> позволяет получить больше информации о различных объектах.<br>Команда <span style="color: white;">ВЫХОД</span> позволяет вернуться на стартовый экран.';
            break;
        case "выход":
